...
var validatorTemplate = [
    '<form class="JSONValidate" method="post" action="." name="JSONValidate">',
        '<textarea class="json_input" name="json_input" class="json_input" rows="30" cols="100" spellcheck="false" placeholder="Enter json or a url to validate...">',
        '</textarea>',
        '<a href="#" title="Run validation" class="button validate">',
            '<span class="icon">Lint Me!</span>',
        '</a>',
        '<a href="#" title="Compare two JSON sets" class="button split-view">',
            '<span class="icon">Split View</span>',
        '</a>',
        '<a href="#" title="Delete the current data" class="button reset">',
